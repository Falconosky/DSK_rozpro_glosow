...
def send_messages_thread(ktory_socket, czujniki_porty, message_queue):
...
def czujnik(ktory_socket):
    ...
    threading.Thread(target=send_messages_thread, args=(ktory_socket, czujniki_porty, message_queue)).start()
